...
<html>
    ...
    <body>
        ...
        <div class="container">-
            <div class="row">
                <div class="col-lg-3">
                    <h2 style="color: greenyellow" class="my-4">Manager Page</h2>
                    <div class="list-group">
                        <a href="../managerServlet" class="list-group-item">Process Beer</a>
                        <a href="../promotionServlet" class="list-group-item">Process Promotion</a>
                        <a href="../orderManagementServlet" class="list-group-item">Order Management</a>
                    </div>
                </div>
