            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <form action="../managerServlet" method="post"  id="form">
                        ...
                        <label>Beer ID: </label>
                        <input type="text" name="beerID" required=""><br>

                        <label>Beer Name: </label>
                        <input type="text" name="beerName" required=""><br>

                        <label>Detail: </label>
                        <input type="text" name="detail" required=""><br>

                        <label>Quantity In Store: </label>
                        <input type="text" name="quantityInStore" required="" ><br>

                        <label>Price: </label>
                        <input type="text" name="price" required=""><br>

                        <label>Brand ID: </label>
                        <input type="text" name="brandID" required=""><br>

                        <label>Image: </label>
                        <input type="text" name="image" required=""><br>

                        <label>Date Join: </label>
                        <input type="text" name="dateJoin" required=""><br>

                        <label>Information: </label>
                        <textarea style="margin-left: 7px; width: 15em" type="text" name="information" required=""></textarea><br>
