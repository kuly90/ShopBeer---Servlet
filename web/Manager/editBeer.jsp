        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <form action="managerServlet" method="post" id="form">
                        <input type="hidden" name="action" value="update">
                        <label>Beer ID: </label>
                        <input type="text" name="beerID" value="${beer.beerID}" readonly=""><br>

                        <label>Beer Name: </label>
                        <input type="text" name="beerName" value="${beer.beerName}"><br>

                        <label>Detail: </label>
                        <input type="text" name="detail" value="${beer.detail}"><br>

                        <label>quantity In Store: </label>
                        <input type="text" name="quantityInStore" value="${beer.quantityInS}" ><br>

                        <label>Price: </label>
                        <input type="text" name="price" value="${beer.price}"><br>

                        <label>Brand ID: </label>
                        <input type="text" name="brandID" value="${beer.brandID}"><br>

                        <label>Image: </label>
                        <input type="text" name="image" value="${beer.image}"><br>

                        <label>Date Join: </label>
                        <input type="text" name="dateJoin" value="${beer.dateJoin}"><br>
